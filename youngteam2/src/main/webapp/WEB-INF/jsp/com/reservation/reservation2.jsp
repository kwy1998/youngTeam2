					...
					<div class="page reats" id="sub_page">
						...
						<table class="hm_tab">
							<tbody>
								...
								<tr>
									<th>예약자명</th>
									<td><input type="text" name="resName" value=""
										title="예약자명"></td>
								</tr>

								<tr>
									<th>핸드폰번호</th>
									<td><input type="text" name="phone" value="" title="핸드폰번호">&nbsp;예)&nbsp;051-000-0000</td>
								</tr>
								<tr>
									<th>차번호</th>
								...
								<tr>
									<th>차종</th>
									<td><input type="text" name="carKinds" value="" title="차종"></td>
								</tr>
							</tbody>
						</table>
